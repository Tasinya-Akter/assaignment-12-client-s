...
const Footer = () => {
  return (
    <div>
      <div className="flex footer-img items-end w-full ">
        <footer className="w-full text-gray-700 animate-text sticky top-0 right-0 z-30 body-font">
            ...
            <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
              ...
              <div className="mt-4">
                <span className="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                  <a className="text-gray-800 cursor-pointer hover:text-gray-700">
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
                  ...
                  <a className="ml-3 text-gray-800 cursor-pointer hover:text-gray-700">
                    <svg
                      fill="currentColor"
                      strokeLinecap="round"
                      strokeLinejoin="round"
            ...
            <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
              <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                ...
                <nav className="mb-10 list-none">
                  <li className="mt-3">
                    <a className="text-gray-800 cursor-pointer hover:text-gray-900">
                      Company
                    </a>
                  </li>
                  <li className="mt-3">
